...
# ===================== 配置区 =====================
PDF_PATH = r"C:\Users\19655\Desktop\材料汇总-Luo\作品集\信达医药-维立志博-B(9887)创新药企巡礼系列：全球领先的基于条件性激活技术的IO 2.0+ADC 2.0 Biotech.pdf"
OUT_GIF = r"D:\Trae CN\program\Portfolio\public\Biotech.gif"
GROUP_SIZE = 3
SCALE = 0.55
FRAME_DELAY = 700
